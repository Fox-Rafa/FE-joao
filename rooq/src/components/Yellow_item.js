...
const Yellow_item = (props) => {
  return (
    <View style={styles.item}>
        <View style={styles.topbk}> 
            <Text style={styles.namevs}>{props.patientName}</Text>
            <TouchableOpacity style={styles.exambt} onPress={() => props.navigation.navigate('PEoverview', {id: props.id,
                                                                                                            v1: props.v1,
                                                                                                            v2: props.v2,
                                                                                                            v3: props.v3,
                                                                                                            v4: props.v4,
              ...
              <Image source={require('../images/backyellow.png')} style={styles.morevs}/>
            </TouchableOpacity>
        </View>
        <View style={styles.midvs}>
            ...
            <Text style={styles.diagvs}>{props.diagno}</Text>
        </View>
