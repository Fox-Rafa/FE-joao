  ...
  return (
    <View style={styles.container}>
      ...
      <LineChart
        ...
        data={{
          dataSets: [{
            values: array_to_xy_dict(Array.from(sent.data)),
            label: 'Sine function',
        ...
        yAxis={{
          left: {
            granularityEnabled: true,
            granularity: 0.0000000000000001
          },
          right: {
            granularityEnabled: true,
            granularity: 100
        ...
        scaleEnabled={false}
        visibleRange={{ x: { min: 0, max: 1 } }} //, y: { left: { min: -1000, max: 1000 }, right: { min: -1000, max: 1000 } } 
      />
